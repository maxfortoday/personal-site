...
const positions: Position[] = [{
  ...
  points: [
    ...
    'Built the Observability Platform — centralised monitoring pipelines, real-time alerting standards, and incident runbooks across all services — reducing MTTR by ~60%.',
    'Mentor and develop Team Leads as a force multiplier: leadership capacity, not just code output.',
    'Introduced AI-assisted engineering workflows (agentic code review, architecture planning, automated documentation) that improved delivery velocity across multiple engineering workflows.',
  ],
}, {
  company: 'Aman Group / Phoenix Insurance',
  ...
  points: [
    ...
    'Drove the zero-downtime Nahal App Migration: CDC pipeline (AWS DMS), dual-system rollout, per-user feature flags, and full legacy decommission.',
  ...
  points: [
    ...
    'Delivered the Secure API & Auth Layer: unified Auth0 authentication for 500+ B2B clients at 2M+ API calls/day — without modifying a single legacy system.',
